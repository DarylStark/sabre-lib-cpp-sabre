...
namespace sabre::impl::sabre_test_mocks
{
    ...
    public:
        ...
        sabre::core::Uart::UniquePtr createUartObject(uint32_t uartNumber, int32_t baudRate,
        ...
        sabre::core::WaitFor::UniquePtr createWaitFor(sabre::core::WaitForPred fn, uint64_t timeoutInMs,
                                     uint64_t sleepTime) const;
        sabre::core::Service::UniquePtr createService(sabre::core::ServiceHandler fn) const;
